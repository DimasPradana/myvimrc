...
let g:colors_name='dimas_colorscheme'
set background=dark


if ! exists("g:dimas_colorscheme_termcolors")
  let g:dimas_colorscheme_termcolors = 256
endif

" not all terminals support italics properly.  If yours does, opt-in.
if ! exists("g:dimas_colorscheme_terminal_italics")
  let g:dimas_colorscheme_terminal_italics = 0
endif
...
function! s:h(group, style)
  " Not all terminals support italics properly. If yours does, opt-in.
  if g:dimas_colorscheme_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:dimas_colorscheme_termcolors == 16
...
call s:h("ColorColumn",   {"bg": s:dark_green})

" remainder of syntax highlighting
" call s:h("MatchParen",    {"bg": s:bg_subtle, "fg": s:purple, "gui": "bold", "cterm": "bold"})
call s:h("MatchParen",    {"bg": s:dark_blue, "fg": s:dark_green, "gui": "underline,italic", "cterm": "underline,italic"}) "dimas
...
hi! link goString			Special
hi! link goDeclaration      Keyword
hi! link goConditional      Constant
hi! link goStatement		Identifier
hi! link goRepeat			Number
hi! link goConstant			PreProc
hi! link goBuiltins			Keyword
hi! link goDeclType			PreProc
hi! link goType				Number
hi! link goRawString		Identifier
